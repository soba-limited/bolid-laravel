...
//*************************************************************
// Rule
//1.  use App\Http\Requests\LPickupsValidation; //Add Controller
//2.  public function store( LPickupsValidation $request ){ //example
//*************************************************************

class LPickupsValidation extends FormRequest
{
    /**
