...
class DShopController extends Controller
{
    ...
    public function shop_create_url(Request $request)
    {
        ...
        if (!empty($page_check->id)) {
            ...
            $screenshot = Http::withToken("mSg80X4ZLeCtBmW94xGvDSx5gqRRyoci2aTSKKrw")->get("https://screendot.io/api/standard?url=".$request->url."&delay=5000&browserWidth=1400&browserHeight=2100&width=470&format=webp&refresh=true&response=json")->body();
